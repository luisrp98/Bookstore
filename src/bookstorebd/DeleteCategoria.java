 ...
 * @author rnavarro
 */
public class DeleteCategoria extends javax.swing.JDialog {
     ...
     */
    public DeleteCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteCategoria(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT nombre_categoria FROM categorias_libros ORDER BY nombre_categoria";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM categorias_libros WHERE nombre_categoria = \'%s\'",name);
