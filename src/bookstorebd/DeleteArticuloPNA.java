 ...
 * @author rnavarro
 */
public class DeleteArticuloPNA extends javax.swing.JDialog {
     ...
     */
    public DeleteArticuloPNA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteArticuloPNA(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT num_articulo FROM articulos_pedido ORDER BY num_articulo";
        ResultSet rs = null;
        try {
    ...
    private void initComponents() {
        ...
        setTitle("Borrar articulo pedido");
        setModal(true);
        setResizable(false);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM articulos_pedido WHERE  num_articulo = \'%s\'",name);
