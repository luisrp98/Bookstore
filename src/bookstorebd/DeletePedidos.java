 ...
 * @author rnavarro
 */
public class DeletePedidos extends javax.swing.JDialog {
     ...
     */
    public DeletePedidos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeletePedidos(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM pedidos WHERE id_pedido = \'%s\'",name);
