 ...
 * @author rnavarro
 */
public class DeleteAutores extends javax.swing.JDialog {
     ...
     */
    public DeleteAutores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteAutores(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT nombre_autor FROM autores ORDER BY nombre_autor";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM autores WHERE nombre_autor = \'%s\'",name);
