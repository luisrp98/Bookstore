 ...
 * @author rnavarro
 */
public class DeleteLibros extends javax.swing.JDialog {
     ...
     */
    public DeleteLibros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteLibros(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT titulo_libro FROM libros ORDER BY titulo_libro";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM libros WHERE titulo_libro = \'%s\'",name);
