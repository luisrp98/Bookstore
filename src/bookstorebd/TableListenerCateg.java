 ...
 * @author rnavarro
 */
public class TableListenerCateg implements TableModelListener  {
    
    private final Database db;
    
    public TableListenerCateg(Database d) {
        super();
        db = d;
    }
    ...
    public void tableChanged(TableModelEvent event) {
        ...
        String sql = String.format(
                "UPDATE categorias_libros SET %s = '%s' WHERE codigo_categ = \'%s\'",
                colSQLName,
