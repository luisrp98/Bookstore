 ...
 * @author rnavarro
 */
public class DeleteArticuloPIP extends javax.swing.JDialog {
     ...
     */
    public DeleteArticuloPIP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteArticuloPIP(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT id_pedido FROM articulos_pedido ORDER BY id_pedido";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM articulos_pedido WHERE  id_pedido = \'%s\'",name);
