 ...
 * @author rnavarro
 */
public class DeleteCliente extends javax.swing.JDialog {
     ...
     */
    public DeleteCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        db = null;
        initComponents();
    ...
    public DeleteCliente(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void buildCombo() {
        final String sql = "SELECT cte_name FROM clientes ORDER BY cte_name";
        ResultSet rs = null;
        try {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            ...
            String sql = String.format("DELETE FROM clientes WHERE cte_name = \'%s\'",name);
